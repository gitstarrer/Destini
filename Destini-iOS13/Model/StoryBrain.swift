...
struct  StoryBrain {
    let quiz = [
        ...
        Story(
            q: "He nods slowly, unfazed by the question.",
...
var stage = 0
    ...
    func  getNextStage(_ choice: String) -> Int {
        if choice == quiz[stage].choice1{
            return quiz[stage].choice1Destination
        }else{
            return quiz[stage].choice2Destination
        }
    }
